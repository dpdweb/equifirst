...
export default function FinaMortgageServices() {
  return (
      ...
      <div className="mx-auto w-full max-w-[1366px] pt-5 md:pt-5 px-4 sm:px-6 lg:px-8">
      
      <div className="grid md:grid-cols-[490px_1fr] gap-6">
        
        <div className="mb-6 md:md-0">
          <div className="pre-mobile-heading md:pre-heading">How We Help You</div>
          <h1 className="text-ef-mobile-heading1-size md:text-ef-heading1-size text-ef-dark-blue">
            Our Mortgage Services
          </h1>
        </div>

        <div className="md:h-[130px] flex items-center">
          <p>
