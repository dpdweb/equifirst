...
export default function SubPageHeroBanner({ title, subtitle, image }: HeroBannerProps) {
  return (
    <section className="relative md:rounded-4xl overflow-hidden max-w-8xl mx-auto h-[600px] md:h-[550px]">
  {/* Background Image */}
  ...
  {/* Text Overlay */}
  <div className="relative z-10 px-6 pt-50 pb-50 md:pt-45 md:pb-40 md:px-16 text-white max-w-4xl">
    {title && (
